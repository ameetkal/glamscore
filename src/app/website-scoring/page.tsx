...
import { WEBSITE_SCORING_CRITERIA } from '@/types/website';

export default function WebsiteScoring() {
  return (
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Understand how we evaluate your website's effectiveness
          </p>
          <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div className="text-left space-y-4 text-gray-600">
              <p>
                Our scoring system evaluates your website across six key categories: Technical SEO, On-Page SEO, Content Completeness, Branding Consistency, Social & Contact Integration, and Security & Accessibility. Each category contains specific criteria that contribute to your overall score.
              </p>
              ...
              <p>
                After the initial AI analysis, you can manually adjust any criteria that may have been incorrectly evaluated. This ensures you get the most accurate score possible for your website.
              </p>
            </div>
          </div>
          <div className="mt-4">
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-8">
          <div className="space-y-8">
            {WEBSITE_SCORING_CRITERIA.map((category, index) => (
